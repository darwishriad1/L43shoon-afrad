...
export default function SupplyManagement({
  ...
  // 1. Initial Sample Supply Inventory Items
  const [items, setItems] = useState<SupplyItem[]>([
    {
      id: 'sup-1',
      code: 'SUP-AK47-01',
      name: 'آلي كلاشنكوف AK-47 تكتيكي معدل',
      category: 'أسلحة وذخائر',
      unitOfMeasure: 'قطعة',
      currentStock: 145,
      ...
      totalReceived: 200,
      totalIssued: 55,
      supplier: 'دائرة التسليح والإمداد المركزي',
      warehouseLocation: 'مخزن التسليح A1 - رف 04',
      lastRestockDate: '2026-07-20',
      status: 'جاهز وفرة',
      condition: 'جديد بكرتونه',
      batchNo: 'BATCH-2026-AK',
      serialNumber: 'AK-TACTICAL-2026-99',
      unitPrice: 3500,
      notes: 'فحص فني مكتمل - مطابقة لمعايير الجاهزية القتالية'
    },
    {
      id: 'sup-2',
      code: 'SUP-AMMO-762',
      name: 'ذخيرة حي 7.62x39 ملم (صناديق حديد)',
      category: 'أسلحة وذخائر',
      unitOfMeasure: 'صندوق',
      currentStock: 18,
      ...
      totalReceived: 100,
      totalIssued: 82,
      supplier: 'مستودع الذخائر الإستراتيجي',
      warehouseLocation: 'المخزن S2 - التحصين الشرقي',
      lastRestockDate: '2026-06-15',
      status: 'مخزون حرج',
      condition: 'جديد صالح',
      batchNo: 'AMM-762-884',
      unitPrice: 1200,
      notes: 'يتطلب إذن توريد عاجل لسد العجز القياسي'
    },
    {
      id: 'sup-3',
      code: 'SUP-RAD-HYT',
      name: 'جهاز لاسلكي مشفر HYT HP780 M-Spec',
      category: 'أجهزة إشارة واتصالات',
      unitOfMeasure: 'طقم',
      currentStock: 42,
      ...
      totalReceived: 60,
      totalIssued: 18,
      supplier: 'ركن الإشارة والاتصالات باللواء',
      warehouseLocation: 'مخزن الاتصالات B2 - كابينة 12',
      lastRestockDate: '2026-07-10',
      status: 'جاهز وفرة',
      condition: 'جديد بكرتونه',
      batchNo: 'COMM-HYT-99',
      serialNumber: 'RAD-HP780-4410',
      unitPrice: 4200,
      notes: 'مصحوب ببطاريتين إضافيتين وشاحن سريع وسماعة أذن'
    },
    {
      id: 'sup-4',
      code: 'SUP-NVG-N2',
      name: 'مناظير رؤية ليلية تكتيكية NVG-PVS14 الجيل الثالث',
      category: 'مهمات وعتاد فردي',
      unitOfMeasure: 'قطعة',
      currentStock: 8,
      ...
      totalReceived: 25,
      totalIssued: 17,
      supplier: 'دائرة التجهيزات العسكرية الخاصة',
      warehouseLocation: 'خزينة المهمات الخاصة C1',
      lastRestockDate: '2026-05-18',
      status: 'مخزون حرج',
      condition: 'مستعمل ممتازة',
      batchNo: 'NVG-GEN3-2026',
      serialNumber: 'NVG-PVS-9901',
      unitPrice: 18000,
      notes: 'عهدة عالية الحساسية وخاضعة لجداول الفحص الدقيق'
    },
    {
      id: 'sup-5',
      code: 'SUP-UNI-TAC',
      name: 'بدلة عسكرية تكتيكية صحراوية (شاملة الخوذة والجاكيت)',
      category: 'ألبسة وتجهيزات',
      unitOfMeasure: 'طقم',
      currentStock: 210,
      ...
      totalReceived: 300,
      totalIssued: 90,
      supplier: 'المستودع العام للمهمات والألبسة',
      warehouseLocation: 'مخزن المهمات العامة M1',
      lastRestockDate: '2026-07-25',
      status: 'جاهز وفرة',
      condition: 'جديد بكرتونه',
      unitPrice: 450,
      notes: 'مقاسات متنوعة مجهزة ببطانات حماية حرارية'
    },
    {
      id: 'sup-6',
      code: 'SUP-RAT-MRE',
      name: 'وجبات معركة جاهزة MRE (إعاشة ميدانية عالية البروتين)',
      category: 'مؤن وإعاشة',
      unitOfMeasure: 'كرتون',
      currentStock: 350,
      ...
      totalReceived: 500,
      totalIssued: 150,
      supplier: 'شؤون التموين والتغذية الميدانية',
      warehouseLocation: 'مستودع الإعاشة المركزي - رف 08',
      lastRestockDate: '2026-07-28',
      status: 'جاهز وفرة',
      condition: 'جديد بكرتونه',
      expiryDate: '2028-12-31',
      unitPrice: 180,
      notes: 'صالحة لغاية 2028 ومقاومة للظروف المناخية القاسية'
    },
    {
      id: 'sup-7',
      code: 'SUP-MED-FAK',
      name: 'حقيبة إسعافات ميدانية متقدمة (IFAK) للخطوط الأمامية',
      ...
      totalReceived: 80,
      totalIssued: 15,
      supplier: 'الخدمات الطبية العسكرية',
      warehouseLocation: 'مستودع العيادة والمستلزمات الطبية',
      lastRestockDate: '2026-07-22',
      status: 'جاهز وفرة',
      condition: 'جديد بكرتونه',
      expiryDate: '2027-09-15',
      unitPrice: 650,
      notes: 'تحتوي على رباط ضاغط شرياني (CAT) ومضاد نزيف سريع'
    }
  ]);

  // 2. Initial Sample Transactions Data (التوريد والصرف)
  const [transactions, setTransactions] = useState<SupplyTransaction[]>([
    {
      id: 'tx-101',
      type: 'توريد_جديد',
      itemCode: 'SUP-RAT-MRE',
      itemName: 'وجبات معركة جاهزة MRE (إعاشة ميدانية)',
      quantity: 150,
      recipientOrSupplier: 'شؤون التموين والتغذية باللواء',
      date: '2026-07-28',
      voucherNo: 'REC-2026-8821',
      handlerName: 'نقيب / عبد الله المري (مسؤول التموين)',
      conditionAtTx: 'جديد بكرتونه',
      inspectionApproved: true,
      notes: 'تم الاستلام والفحص ومطابقة الكميات مع محضر الشحن',
      status: 'مكتمل'
    },
    {
      id: 'tx-102',
      type: 'صرف_عهدة',
      itemCode: 'SUP-AK47-01',
      itemName: 'آلي كلاشنكوف AK-47 تكتيكي معدل',
      quantity: 5,
      recipientOrSupplier: 'الكتيبة الأولى - السرية الثانية',
      unitName: 'الكتيبة الأولى',
      date: '2026-07-27',
      voucherNo: 'ISS-2026-4402',
      handlerName: 'ملازم أول / حسن الشحري',
      conditionAtTx: 'جديد بكرتونه',
      inspectionApproved: true,
      notes: 'تسليم عهدة عسكرية رسمية للمهمة الحالية',
      status: 'مكتمل'
    },
    {
      id: 'tx-103',
      type: 'صرف_عهدة',
      itemCode: 'SUP-RAD-HYT',
      itemName: 'جهاز لاسلكي مشفر HYT HP780',
      quantity: 3,
      recipientOrSupplier: 'الفرد: فهد ناصر الماربي (MIL-1008)',
      militaryNo: 'MIL-1008',
      date: '2026-07-25',
      voucherNo: 'ISS-2026-4390',
      handlerName: 'ملازم أول / حسن الشحري',
      conditionAtTx: 'جديد صالح',
      inspectionApproved: true,
      notes: 'صرف عهدة فردية مع البرمجة والتشفير الميداني',
      status: 'مكتمل'
    },
    {
      id: 'tx-104',
      type: 'توريد_جديد',
      itemCode: 'SUP-MED-FAK',
      itemName: 'حقيبة إسعافات ميدانية متقدمة (IFAK)',
      quantity: 80,
      recipientOrSupplier: 'الخدمات الطبية العسكرية المركزية',
      date: '2026-07-22',
      voucherNo: 'REC-2026-8805',
      handlerName: 'نقيب / عبد الله المري',
      conditionAtTx: 'جديد بكرتونه',
      inspectionApproved: true,
      status: 'مكتمل'
    }
  ...
  const [suppliersList] = useState<SupplierInfo[]>([
    {
      id: 'sup-dir-1',
      name: 'دائرة التسليح والإمداد المركزي',
      type: 'دائرة الإمداد والتموين',
      contactPerson: 'عقيد / خالد بن سلطان العتيبي',
      phone: '011-4882100',
      city: 'الرياض - القيادة العامة',
      totalVouchersDelivered: 42,
      rating: 'ممتاز'
    },
    {
      id: 'sup-dir-2',
      name: 'مستودع الذخائر الإستراتيجي الشمالي',
      type: 'مستودع إستراتيجي مركزي',
      contactPerson: 'مقدم / سعيد القحطاني',
      phone: '014-4221190',
      city: 'تبوك - القاعدة الشمالية',
      totalVouchersDelivered: 28,
      rating: 'ممتاز'
    },
    {
      id: 'sup-dir-3',
      name: 'ركن الإشارة والاتصالات بالمنطقة',
      type: 'قيادة المنطقة',
      contactPerson: 'رائد مهندس / عمر الجحدلي',
      phone: '017-2283000',
      city: 'خميس مشيط',
      totalVouchersDelivered: 19,
      rating: 'جيد جداً'
    },
    {
      id: 'sup-dir-4',
      name: 'شؤون التموين والتغذية الميدانية',
      type: 'دائرة الإمداد والتموين',
      contactPerson: 'نقيب / فهد العرابي',
      phone: '012-6652010',
      city: 'المنطقة الجنوبية',
      totalVouchersDelivered: 35,
      rating: 'ممتاز'
    }
  ]);
